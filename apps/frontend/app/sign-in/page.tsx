      ...
      <div className="relative flex h-full w-full items-center justify-center">
        ...
        >
          ...
          <div className="z-20 mb-8 flex items-center justify-center text-[14px] text-neutral-400">
            First Time here?
            <div className="group ml-2 cursor-pointer transition-colors duration-300">
              <span
                className="text-blue-500 group-hover:bg-gradient-to-l group-hover:from-blue-500 group-hover:to-blue-300 group-hover:bg-clip-text group-hover:text-transparent"
