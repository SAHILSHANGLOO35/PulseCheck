      ...
      <div className="relative flex items-center justify-center w-full h-full">
        ...
        >
          ...
          <div className="flex items-center justify-center text-neutral-400 text-[14px] mb-8 z-20">
            First Time here?
            <div className="ml-2 group cursor-pointer transition-colors duration-300">
              <span className="text-blue-500 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-l group-hover:to-blue-300 group-hover:from-blue-500" onClick={() => router.push('/sign-up')}>
                Sign Up.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center text-neutral-400 text-[14px] mb-8">
            Ready to enjoy the features of Pulse Check.
          </div>
        </motion.div>
      </div>
    </div>
